...
*   Receiving XML from a web service (defined in an [imported web service](/refguide/consumed-web-service/)) in a [Call Web Service Action](/refguide/call-web-service-action/) activity.
*   Receiving XML or JSON from a call action [Call Rest Action](/refguide/call-rest-action/).
...
![](/attachments/refguide7/desktop-modeler/integration/mapping-documents/16843933.png)
...
*   Sending XML to a web service (defined in an [imported web service](/refguide/consumed-web-service/)) in a [Call Web Service Action](/refguide/call-web-service-action/) activity.
...
![](/attachments/refguide7/desktop-modeler/integration/mapping-documents/16843940.png)
