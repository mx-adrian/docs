...
The password text box is a widget that can be used to provide a password for authentication. It must be placed on a page together with a [login id text box](/refguide/login-id-text-box/) and a [sign-in button](/refguide/sign-in-button/).
