...
| --- | --- |
| **Responsive** | Use this layout for pages that will work fine on all types of devices. The [layout grid](/refguide/layout-grid/) and other widgets make it possible to create responsive pages. |
