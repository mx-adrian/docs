...
* Items with the **Sign out** event are not shown for anonymous users. For more information on different security levels and anonymous users, see [Project Security](/refguide/project-security/) and [Anonymous Users](/refguide/anonymous-users/). 
