...
{{% alert type="info" %}}
For this how-to, Mendix Studio Pro v8.15.1 is required. If you are using an older Studio Pro version, please use [How to Build a Mendix Native Mobile App Locally Manually](/howto/mobile/native-build-locally-manually/).
{{% /alert %}}
