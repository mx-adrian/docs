...
Mendix Studio is the place where you can create, view and edit your Mendix applications without going into technical details. For this purpose you can use [Studio Pro](/refguide/modeling/) and  anytime. 
...
You may also see a top bar suggesting an upgrade to the next Mendix version. For more information on Studio upgrades and Mendix versions, see .
...
| ------------------------------------ | ------------ | ------------------------------------------------------------ |
|                  | 1            | Shows a list of all pages in the app. Select a page to open it. |
|        | 2            | Shows the domain models of the app.                          |
|              | 3            | Shows a list of all microflows in the app. Select a microflow to open it. |
|                | None         | Shows a list of all workflows in the app. Select a workflow to open it. |
|     | 4            | Shows a configured menu in the form of a navigation tree. You can expand the menu structure of the navigation tree up to two levels with an unlimited amount of pages. |
...
|  | None         | Allows you to style your app with custom branding, colors, and typography. |
|                  | None         | **Settings** consists of **Roles and Permissions** and **Widget Overview**. <br />Via  you can manage access to your app for different type of users.  <br />The  gives you an overview of all widgets and their status. Widgets are user interface elements (alerts, buttons, charts, etc.) that are used to build pages. |
...
|  | Allows an app development team to make comments to different pages, microflows, domain models, and layouts of Studio, and interact with each other. |
...
|  | Shows you what your app will look like after it is published. |
|  | You can publish your app with this button. Click **Publish** > **Update** to publish the latest changes you made in Studio. For more information, see  |
|  | Displays consistency errors (if any) that prevent your app from being previewed and published. For more information on errors, see .<br />You can also use <kbd>C</kbd> shortcut to view the **Checks** panel. |
...
| **More Options** icon | Provides additional information. You will find the following:<ul><li>**About** – shows the information on the  </li><li>**Keyboard Shortcuts** – opens the list of shortcuts in Studio</li><li>**Take a Product Tour** – starts a  the guided product introduction tour and shows you around Studio</li><li>**Contact Mendix Support** – a link to the </li><li>**Open App Buzz** – takes you to the [App Buzz](/developerportal/collaborate/buzz/#app-buzz) in the Developer Portal</li><li>**Edit in Studio Pro** – opens your app in Studio Pro</li></ul> |
...
Workflows, pages, microflows, and enumerations can be copied to clipboard and then pasted to a different Studio app. You can also copy and paste them to the same app, however, there is the **Duplicate** option you can use for this purpose. For more information on how to copy, paste, or duplicate workflows, pages, microflows, and enumerations, see , , , and  respectively.  
...
*  – explains how Studio version correlates to the Mendix version
