...
A data view and list view belong to the **Data Container** category of widgets. For more information on different widget categories, see . 
...
* **Read-Only** (enabled by default) – when enabled, all  (for example, a text area, a check box) in the list view will be in read-only mode
