...
In this document, we explain how to solve the most common consistency errors that can occur when configuring the domain model in Mendix Studio. For more information on domain models, see .
...
For more information on delete behavior, see section the  section in *Associations*.
