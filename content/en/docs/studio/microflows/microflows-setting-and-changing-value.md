...
For more information on the functions of these activities, see . 
...
1. Add the **Create Object**/**Change Object** activity to a microflow. For more information, see the  section in *Microflows*.
...
1. Add the **Create Variable**/**Change Variable** activity to a microflow. For more information on how to add an element to a microflow, see the  section in *Microflows*.
2. Click the activity to view its properties.
...
1. Add the **End Event** to a microflow or select the existing end event. For more information, see the  section in *Microflows*.
