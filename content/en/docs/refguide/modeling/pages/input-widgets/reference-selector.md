...
A reference selector must be placed in a [data widget](/appstore/modules/data-widgets/). The object(s) retrieved by this data widget must be at the *many* end of a one-to-many association, or at either end of a one-to-one association.
