...
Each device type contains a default menu. You can use these menus in [Menus & Navigation](menu-widgets). Defining the menu for a device type works the same as when editing a menu document. For more details, see [Menu](/refguide/menu/).
