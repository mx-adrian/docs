...
When working with the Mendix Platform, objects of entities are always being manipulated. This happens implicitly within [data containers](/appstore/modules/data-widgets/) on a page, or explicitly using activities in microflows and nanoflows.
